...
options_order = { "alertDeath", "alertUpgrade", "showText" }
options = {
  alertDeath = {
  ...
  showText = {
    ...
    desc = "Also print a game_message to screen for each event.",
...
function widget:GetConfigData()
  return {
    alertDeath   = options.alertDeath   and options.alertDeath.value   or true,
    alertUpgrade = options.alertUpgrade and options.alertUpgrade.value or true,
    showText     = options.showText     and options.showText.value     or false,
  }
end

function widget:SetConfigData(data)
  if type(data) ~= "table" then return end
  if data.alertDeath   ~= nil and options.alertDeath   then options.alertDeath.value   = data.alertDeath   end
  if data.alertUpgrade ~= nil and options.alertUpgrade then options.alertUpgrade.value = data.alertUpgrade end
  if data.showText     ~= nil and options.showText     then options.showText.value     = data.showText     end
end
...
local function SystemText(msg)
  if options.showText and options.showText.value then
